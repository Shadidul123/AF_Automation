...
public class MobileBasePage {
    ...
    protected void tapOn(MobileElement mobileElement) {
        try {
            ...
            e.printStackTrace();
            throw new NoSuchElementException("Unable to locate the Element using: " + mobileElement);
        }
    }
    ...
    protected String getTextFromElement(MobileElement mobileElement) {
        ...
        try {
            ...
            e.printStackTrace();
            throw new NoSuchElementException("Element is not found with this locator: " + mobileElement);
        }
        return text;
    }
